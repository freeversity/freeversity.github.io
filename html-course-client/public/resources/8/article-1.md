...
Если элементам не хватает места, они могут вылезти за границы контейнера. Такое поведение называют _выпадением элементов_. Также говорят, что произошло _переполнение_.

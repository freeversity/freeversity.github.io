...
- Элемент с display: flex; превращается во _«флекс-контейнер»_.
- Непосредственные потомки этого элемента превращаются во _«флекс-элементы»_ и начинают распределяться по новым правилам.
...
### _Выравнивание по поперечной оси_
